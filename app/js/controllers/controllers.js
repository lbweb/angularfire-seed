...
angular.module('myApp.controllers', ['firebase.utils', 'simpleLogin'])
  ...
  .controller('LoginCtrl', ['$scope', 'simpleLogin', '$location', '$rootScope', 'Databox', function($scope, simpleLogin, $location, $rootScope, Databox) {
    $scope.email = null;
    $scope.pass = null;
    $scope.confirm = null;
    ...
    $rootScope.$watch('activeDataBox', function(newVal, oldVal) {
        if (newVal !== undefined) {
            //console.log('activeDataBox:'+newVal)  ;
   ...
   simpleLogin.getUser().then(function(data){
    ...
    $scope.login = function(email, pass) {
      ...
      simpleLogin.login(email, pass)
        .then(function(user) {
              Databox.login(user.uid, function(val){   
                if(val === true) {
